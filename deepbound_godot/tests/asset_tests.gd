...
const SOURCE_AI_IDS := [
	...
	"drow_settlement_structures_ai_reference",
...
const PROP_SIZES := {
	...
	"drow_spider_totem": Vector2i(32, 48),
	"drow_spectral_torch": Vector2i(16, 32),
	"drow_silk_curtain": Vector2i(32, 48),
	"drow_bookshelf": Vector2i(48, 48),
	"drow_rift_crystal": Vector2i(16, 32),
	"drow_wall_map": Vector2i(48, 32),
	"drow_weapon_rack": Vector2i(32, 32),
	"drow_iron_railing": Vector2i(32, 16),
	"drow_chain_ladder": Vector2i(16, 48),
	"drow_cocoon": Vector2i(16, 32),
	"drow_web_cluster": Vector2i(32, 32),
	"drow_back_house_lit": Vector2i(48, 32),
	"drow_back_house_dark": Vector2i(48, 32),
}
